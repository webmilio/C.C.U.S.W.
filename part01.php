...
<p>La cr&eacute;ation d’un site web requi&egrave;re un environnement de d&eacute;veloppement (aussi appelé: IDE - <i>Integrated Development Environment</i>), que vous en connaissez les bases et que vous savez quelles sont les &eacute;tapes dans la cr&eacute;ation du fichier d'index. Si vous avez de la difficult&eacute; a comprendre le concept jusqu’a maintenant, cliquez <a href="./preface.php">i&ccedil;i</a>.</p>
